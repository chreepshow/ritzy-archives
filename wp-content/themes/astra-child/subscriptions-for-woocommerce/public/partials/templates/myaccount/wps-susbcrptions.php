<?php
/**
 * The add show subscription page.
 *
    ...
    if ( ! empty( $wps_subscriptions ) && is_array( $wps_subscriptions ) ) {
        ...
        <table>
            ...
            <tr>
                ...
                <th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-name"><span class="nobr"><?php esc_html_e( 'Name', 'subscriptions-for-woocommerce' ); ?></span></th>
            ...
            foreach ( $wps_subscriptions as $key => $wps_subscription ) {
                ...
                <tr class="wps_sfw_account_row woocommerce-orders-table__row woocommerce-orders-table__row--status-processing order">
                    ...
                    <td class="wps_sfw_account_col woocommerce-orders-table__cell woocommerce-orders-table__cell-order-name">

                        <?php
                        $wps_subs_name = wps_sfw_get_meta_data( $subcription_id, 'product_name', true );

                        echo esc_html( $wps_subs_name );
                        ?>
                    </td>
                    ...
                    <td class="wps_sfw_account_col woocommerce-orders-table__cell woocommerce-orders-table__cell-order-actions">
							...
							<?php
									...
									">
							<?php
                            esc_html_e( 'Details', 'subscriptions-for-woocommerce' );
                            ?>
									</a>
								</span>
                    </td>
